...
import {useUser} from '@sematica/react'
import  {user} from "@sematica/core"
      ...
      <div className="container">
        <div id="welcome">
          <h1>
            ...
            Welcome @sematica/sematicca-system-com 👋
          </h1>
        </div>
        ...
        <div id="commands" className="rounded shadow">
          ...
          <details>
            ...
            <pre>nx show project @sematica/sematicca-system-com --web</pre>
          </details>
          <details>
            <summary>
              <svg
